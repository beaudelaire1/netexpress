...
CONFIG_EMAIL = "ne-pas-repondre@nettoyage-xpress.fr"
CONFIG_PASSWORD = "Luxama973@"  # "zuvoozfusikgciba"
CONFIG_SERVER = "mail.nettoyage-xpress.fr"            # "smtp.gmail.com"
...
def send_notification(sender, instance, created,  **kwargs):
    if created :
        ...
        EmailService.envoyer_email(message, CONFIG_RECIPIENT, "NOUVELLE TÂCHE NETTOYAGE EXPRESS")
    elif instance.statut_changed():
        message = instance.generer_notification()
        EmailService.envoyer_email(message, CONFIG_RECIPIENT, "CHANGEMENT DE STATUT DE TÂCHE NETTOYAGE EXPRESS")
    elif instance.is_due_soon():
        message = instance.generer_notification()
