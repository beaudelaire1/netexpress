...
import os.path
CONFIG_EMAIL = "vilmebeaudelaire5@gmail.com"
CONFIG_PASSWORD = "zuvoozfusikgciba"
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, "luxama/static")]
...
ALLOWED_HOSTS = ['vilme.pythonanywhere.com',  '127.0.0.1',] #'16.171.148.244',  '127.0.0.1', '0.0.0.0:8000'
