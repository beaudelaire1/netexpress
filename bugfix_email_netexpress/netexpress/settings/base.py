...
INSTALLED_APPS = [
    ...
    # CRM app providing the unified Customer model
    'crm.apps.CrmConfig',
]
...
JAZZMIN_SETTINGS = {
    ...
    "icons": {
        ...
        # Icon for the new unified customer model
...
# Choisir dynamiquement le backend email en fonction des variables
# d'environnement.  Par défaut, on utilise le backend SMTP pour
# l'envoi réel des messages.  En environnement de développement
# (``dev.py``), ce paramètre est surchargé pour utiliser la console.
EMAIL_BACKEND = os.getenv(
    "EMAIL_BACKEND",
    "django.core.mail.backends.smtp.EmailBackend",
)

# Paramètres SMTP.  Ces valeurs peuvent être surchargées via
# l'environnement pour s'adapter à différents fournisseurs (Gmail,
# Infomaniak, etc.).  Les valeurs par défaut pointent vers Gmail.
EMAIL_HOST = os.getenv("EMAIL_HOST", "smtp.gmail.com")
EMAIL_PORT = int(os.getenv("EMAIL_PORT", 587))
EMAIL_USE_TLS = os.getenv("EMAIL_USE_TLS", "True") == "True"
EMAIL_HOST_USER = os.getenv("EMAIL_HOST_USER", "")
EMAIL_HOST_PASSWORD = os.getenv("EMAIL_HOST_PASSWORD", "")
# Adresse d'expéditeur par défaut.  Utilisée si aucune autre adresse
# n'est spécifiée lors de l'envoi d'un email.
